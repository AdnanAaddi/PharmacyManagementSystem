...
public class TestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edate.setOnClickListener(TestActivity.this);
                    ...
                    if (custValidate()) {
                        ...
                        alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(TestActivity.this, "Bill Saved", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(TestActivity.this, "Regular Customer Details not properly entered", Toast.LENGTH_SHORT)
                                .show();
                    }
                } else {
                    Toast.makeText(TestActivity.this, "Fill Details Properly", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        db.child("Items").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                act.setThreshold(1);
                adapter = new AutoAdapter(TestActivity.this, R.layout.m_trans, R.id.item_name, models);
        ...
        dbc.child("Person").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                act2.setThreshold(1);
                autoCustAdapter = new AutoCustAdapter(TestActivity.this, R.layout.m_trans, R.id.item_name, modelcustomers);
        ...
        listadapter = new ListAdapter(TestActivity.this, R.layout.list_items, listmodel);
    ...
    protected void addbtn() {
        ...
        if (listmodel.size() < 8) {
            ...
            if (!item.equals("") && !mrp.equals("") && match.equals(act.getText().toString())) {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (!qt.equals("") && !qt.equals("0")) {
                            ...
                            if (Integer.parseInt(qt) <= Integer.parseInt(o)) {
                                ...
                                gen.setText("GENERATE BILL (Rs" + totamount + ")");
                                ...
                                Toast.makeText(TestActivity.this, "Quantity is not in stock", Toast.LENGTH_SHORT).show();

                            }
                        } else {
                            Toast.makeText(TestActivity.this, "Enter valid quantity", Toast.LENGTH_SHORT).show();
                        }
                ...
                Toast.makeText(TestActivity.this, "Select Item", Toast.LENGTH_SHORT).show();
            }
        }

        else {
            Toast.makeText(TestActivity.this, "No further items can be added", Toast.LENGTH_SHORT).show();
        }
