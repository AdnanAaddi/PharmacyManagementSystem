...
import com.example.pharmacymanagementsystem.adapters.AutoAdapter;
import com.example.pharmacymanagementsystem.adapters.AutoCustAdapter;
import com.example.pharmacymanagementsystem.adapters.ListAdapter;
import com.example.pharmacymanagementsystem.models.ListModel;
import com.example.pharmacymanagementsystem.models.Model;
...
public class NewTransactions extends AppCompatActivity {
    View v;
    String uid;
...
//                    if (custValidate()) {
//
//                        AlertDialog.Builder alert = new AlertDialog.Builder(NewTransactions.this);
...
//                                        });
//
//                                Toast.makeText(NewTransactions.this, "Bill Saved", Toast.LENGTH_SHORT).show();
...
//                        alert.show();
//                    } else {
//                        Toast.makeText(NewTransactions.this, "Regular Customer Details not properly entered", Toast.LENGTH_SHORT)
//                                .show();
//                    }
//                } else {
//                    Toast.makeText(NewTransactions.this, "Fill Details Properly", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
//
...
//
//                act.setThreshold(1);
//                adapter = new AutoAdapter(NewTransactions.this, R.layout.m_trans, R.id.item_name, models);
...
//                act2.setThreshold(1);
//                autoCustAdapter = new AutoCustAdapter(NewTransactions.this, R.layout.m_trans, R.id.item_name, modelcustomers);
...
//        listadapter = new ListAdapter(NewTransactions.this, R.layout.list_items, listmodel);
...
//
//                LayoutInflater layoutInflater = LayoutInflater.from(NewTransactions.this);
//                View promptView = layoutInflater.inflate(R.layout.input_dia, null);
//                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(NewTransactions.this);
...
//                            } else {
//
//                                Toast.makeText(NewTransactions.this, "Quantity is not in stock", Toast.LENGTH_SHORT).show();
//
//                            }
//                        } else {
//                            Toast.makeText(NewTransactions.this, "Enter valid quantity", Toast.LENGTH_SHORT).show();
//                        }
//
//                    }
...
//
//            } else {
//                Toast.makeText(NewTransactions.this, "Select Item", Toast.LENGTH_SHORT).show();
//            }
//        }
//
//        else {
//            Toast.makeText(NewTransactions.this, "No further items can be added", Toast.LENGTH_SHORT).show();
//        }
//
//    }
//
