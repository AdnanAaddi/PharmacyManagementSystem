...
import com.example.pharmacymanagementsystem.AddItems;
...
import com.example.pharmacymanagementsystem.adapters.MyAdapter;
    ...
    public void onResume() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getContext(), AddItems.class);
                startActivity(i);
            }
        });
        fab.show();
