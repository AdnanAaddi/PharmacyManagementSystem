...
import com.example.pharmacymanagementsystem.NewTransactions;
import com.example.pharmacymanagementsystem.R;
import com.example.pharmacymanagementsystem.Trans;
import com.example.pharmacymanagementsystem.Utility;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        holder.del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Trans.gen.setText("GENERATE BILL (Rs" + Trans.totamount + ")");
